...
const creativeSteps = [
  {
    id: 1,
    title: 'Tour Design',
    text: 'We conceive the visual identity of the tour. From the shape of the stage to the flow of the setlist, we design an experience that reflects the artist’s vision on a massive scale.',
    images: [
      'https://www.datocms-assets.com/170269/1766441914-taylor_swift_the_eras_tour_silent-house.jpg?auto=format&fit=crop&w=1200',
      'https://www.datocms-assets.com/170269/1765393804-jonasbrothers_2025tour_silenthouse_03.jpg?auto=format&fit=crop&w=1200'
    ]
  },
  {
    id: 2,
    title: 'Stage Architecture',
    text: 'Building kinetic sculptures and towering structures that break down and travel the world. We design for the reality of the road without compromising the spectacle.',
    images: [
      'https://www.datocms-assets.com/170269/1765306807-ttc_chromakopia_silenthouse_2025_01-1.jpg?auto=format&fit=crop&w=1200'
    ]
  },
  {
    id: 3,
    title: 'Show Direction',
    text: 'Calling the cues that bring the arena to life. We choreograph lighting, video, lasers, and automation into a seamless symphony of live entertainment.',
    images: [
...
export default function TouringClient({ highlights = [] }) {
        ...
        onToggle: (self) => {
          if (self.isActive) {
            ...
            gsap.to(bgRef.current, {
              backgroundColor: index === 0 ? '#ffffff' : index === 1 ? '#fafafa' : '#fcedc7', // subtle orange/yellow for touring
              duration: 0.8,
              ease: 'power2.out'
            })
          }
    ...
    <SmoothScroll>
      ...
      <main className="min-h-screen bg-white text-zinc-950" ref={bgRef}>
        ...
        <section data-header-scheme="light" className="relative h-screen w-full flex items-end justify-center overflow-hidden bg-black">
          <img 
            src="https://www.datocms-assets.com/170269/1765393804-jonasbrothers_2025tour_silenthouse_03.jpg?auto=format&fit=crop&w=2000" 
            alt="Touring Hero" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
            ...
            >
              <p className="text-base sm:text-lg text-zinc-950 font-medium leading-relaxed">
                Silent House Touring transforms arenas and stadiums into massive, immersive environments. We bring scale, artistry, and logistical expertise to the world’s biggest stages.
              </p>
            </motion.div>
            <motion.div 
            ...
            >
              <h2 className="text-4xl sm:text-6xl lg:text-7xl font-[450] tracking-[-0.04em] leading-[1.05] text-zinc-950">
                We deliver extraordinary live experiences to audiences across the globe.
              </h2>
            </motion.div>
          </div>
        </section>
        ...
        <section className="relative px-4 sm:px-8 lg:px-12 pb-32 max-w-screen-2xl mx-auto" ref={containerRef}>
          <div className="flex flex-col lg:flex-row items-start">
            ...
            <div className="hidden lg:block lg:w-5/12 sticky top-0 h-screen py-32 pr-12 flex flex-col justify-between">
              <div>
                <h3 className="text-3xl font-[450] text-zinc-950 mb-16">Touring Architecture</h3>
            ...
            <div className="w-full lg:w-7/12 pt-16 lg:pt-32">
              <div className="lg:hidden mb-12">
                <h3 className="text-3xl font-[450] text-zinc-950">Touring Architecture</h3>
              </div>
              
              <div className="max-w-2xl ml-auto">
                <p className="text-base sm:text-lg text-zinc-950 font-medium mb-24">
                  Creating a tour is an exercise in imagination and engineering. We build worlds that can be constructed, performed in, and packed away every single day.
                </p>
        ...
        <section className="px-4 sm:px-8 lg:px-12 py-32 bg-white">
          <div className="max-w-screen-2xl mx-auto">
            ...
            <div className="relative border-t border-zinc-200">
              ...
              {highlights.length === 0 && (
                <div className="py-12 text-zinc-500 text-sm">No highlights found for Touring.</div>
              )}
